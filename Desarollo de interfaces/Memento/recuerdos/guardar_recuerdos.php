<?php
// guardar_recuerdos.php
// CRUD robusto para XAMPP/Apache: usa GET para leer y POST con "action" para crear/editar/eliminar/importar.
// Evita PUT/DELETE para no depender del servidor.
// Responde SIEMPRE JSON (aunque haya errores).
...
function ensure_schema(&$m){
  // campos esperados (para evitar undefined)
...
try {
  ...
  if ($method === 'POST') {
    ...
    // ----- CREATE (si no hay action o action=create) -----
